...
Do not start another redesign. First complete real-device testing of HomeSmoke 2.6.16 and Remote 2.4.6, then fix only reproduced issues in priority order from `PROJECT_STATUS.md`.
