...
> Исторический план. Актуальный порядок работ: [`../../PROJECT_STATUS.md`](../../PROJECT_STATUS.md). Неактивная Arduino rev2 теперь находится в `archive/firmware-not-used/arduino/`.
...
12. Do not modify the archived rev2 file under `archive/firmware-not-used/arduino/` in this phase.
