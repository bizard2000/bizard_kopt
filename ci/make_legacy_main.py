...
g = re.sub(r"versionName\s+'[^']+'", "versionName '2.1.0-legacy4'", g, count=1)
...
# preserving Bluetooth, PID, sidebar, exact AIA mapping and MQTT gateway. ---
...
print('HomeSmoke Legacy module prepared: minSdk 14 / Android 4.0+')
